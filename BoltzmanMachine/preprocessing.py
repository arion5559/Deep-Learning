...
def import_information_given_sets(training_set, test_set):
    ...
    return training_set, test_set, nb_users
...
def convert_valorations(convert_set):
    convert_set[convert_set == 0] = -1
    convert_set[convert_set == 1] = 0
    convert_set[convert_set == 2] = 0
    convert_set[convert_set >= 3] = 1
    return convert_set
